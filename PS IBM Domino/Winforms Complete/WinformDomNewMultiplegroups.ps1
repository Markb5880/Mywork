...
function WFDomNewDominoMultiGroups {
cls

# Create a New Form
    $form=New-Object System.Windows.Forms.Form
    $form.topmost=$true
    $form.Text="Create Multiple Groups"
    $form.Location.X=25
    $form.Location.Y=75
...
# Add a 'Create Multiple Groups' Button    
    $AddGroupMembersMbutton=New-Object System.Windows.Forms.Button
    $AddGroupMembersMbutton.Location = New-Object System.Drawing.Size(132,100)
    $AddGroupMembersMbutton.Size = New-Object System.Drawing.Size(60,54)
    $AddGroupMembersMbutton.Text = "Create Multiple Groups"
    $AddGroupMembersMbutton.foreColor="Green"
    $AddGroupMembersMbutton.add_click({$GroupCount=$textbox1.Text;$NewGroup=$textbox2.Text
    & "C:\Users\administrator\Documents\Domino Powershell\Complete\PS-DomNewMultipleGroups.ps1";$textbox1.Clear();$textbox2.clear()
        })
