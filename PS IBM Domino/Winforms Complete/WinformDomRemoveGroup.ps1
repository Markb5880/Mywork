...
# Add a 'Remove Group' Button    
    $RemoveGroupbutton=New-Object System.Windows.Forms.Button
    $RemoveGroupbutton.Location = New-Object System.Drawing.Size(110,50)
    $RemoveGroupbutton.Size = New-Object System.Drawing.Size(60,40)
    $RemoveGroupbutton.Text = "Remove Group"
    $RemoveGroupbutton.forecolor = "Green"
    $RemoveGroupbutton.add_click({$RemoveGroup=$textbox1.Text;
    & "C:\Users\administrator\Documents\Domino Powershell\Complete\PS-DomRemoveGroup.ps1";$textbox1.Clear()
        })
